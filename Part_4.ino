...
void setup() {
  ...
  vTaskDelay(1000 / portTICK_PERIOD_MS);
  Serial.println();
  xTaskCreatePinnedToCore(startTask1,"startTask1",1024,NULL,1,&task_1,app_cpu);  //task 1 named as startTask1 is pinned to core 1.//Function=startTask1.name of function=startTask1.stack size=1024byts.task handle=null.core=1
  xTaskCreatePinnedToCore(startTask2,"startTask2",1024,NULL,1,&task_2,app_cpu);  //task 2 named as startTask2 is pinned to core 1.//Function=startTask1.name of function=startTask1.stack size=1024byts.task handle=null.core=1
