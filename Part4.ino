...
void setup() {
  ...
  vTaskDelay(1000 / portTICK_PERIOD_MS);
  Serial.println();
  xTaskCreatePinnedToCore(startTask1,"startTask1",1024,NULL,1,&task_1,app_cpu);  //Function=startTask1.name of function=startTask1.stack size=1024byts.task handle=task_1.core=1
  xTaskCreatePinnedToCore(startTask2,"startTask2",1024,NULL,1,&task_2,app_cpu);  //Function=startTask1.name of function=startTask1.stack size=1024byts.task handle=task_2.core=1
